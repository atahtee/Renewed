...
final List<SubscriptionService> popularSubscriptions = [
  ...
  SubscriptionService('PlayStation Plus', Icons.sports_esports_outlined, Colors.indigo),
  ...
  SubscriptionService('Paramount+', Icons.movie_filter_outlined, Colors.blueAccent),
  ...
  SubscriptionService('Skillshare', Icons.cast_for_education_outlined, Colors.orangeAccent),
  SubscriptionService('Duolingo Plus', Icons.translate_outlined, Colors.lightGreen),
  SubscriptionService('Tidal', Icons.music_video_outlined, Colors.indigoAccent),
  SubscriptionService('Crunchyroll', Icons.theaters_outlined, Colors.deepOrange),
  SubscriptionService('Game Pass Ultimate', Icons.sports_esports_outlined, Colors.lightGreen),
  SubscriptionService('Nintendo Switch Online', Icons.sports_esports_outlined, Colors.redAccent),
  ...
  SubscriptionService('Headspace', Icons.self_improvement_outlined, Colors.blueAccent),
  ...
  SubscriptionService('MasterClass', Icons.school_outlined, Colors.yellowAccent),
  SubscriptionService('HelloFresh', Icons.restaurant_outlined, Colors.green),
SubscriptionService('Birchbox', Icons.face_retouching_natural_outlined, Colors.pink),
...
SubscriptionService('ClassPass', Icons.fitness_center_outlined, Colors.orange),
