...
const SubscriptionSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'intervalInDays': PropertySchema(
      id: 1,
      name: r'intervalInDays',
      type: IsarType.long,
    ),
...
void _subscriptionSerialize(
  ...
  writer.writeLong(offsets[1], object.intervalInDays);
  writer.writeString(offsets[2], object.name);
  writer.writeDateTime(offsets[3], object.nextReminder);
  writer.writeString(offsets[4], object.planType);
...
Subscription _subscriptionDeserialize(
  ...
  object.id = id;
  object.intervalInDays = reader.readLong(offsets[1]);
  object.name = reader.readString(offsets[2]);
  object.nextReminder = reader.readDateTimeOrNull(offsets[3]);
  object.planType = reader.readString(offsets[4]);
...
extension SubscriptionQueryFilter
  ...
  QueryBuilder<Subscription, Subscription, QAfterFilterCondition>
      intervalInDaysEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'intervalInDays',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<Subscription, Subscription, QAfterFilterCondition>
      nextReminderEqualTo(DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'nextReminder',
        value: value,
...
extension SubscriptionQuerySortBy
  ...
  QueryBuilder<Subscription, Subscription, QAfterSortBy>
      sortByIntervalInDays() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'intervalInDays', Sort.asc);
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterSortBy>
      sortByIntervalInDaysDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'intervalInDays', Sort.desc);
    });
  }
  ...
  QueryBuilder<Subscription, Subscription, QAfterSortBy> sortByNextReminder() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subscription, Subscription, QAfterSortBy>
      sortByNextReminderDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'nextReminder', Sort.desc);
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterSortBy> sortByPlanType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'planType', Sort.asc);
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterSortBy> sortByPlanTypeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SubscriptionQuerySortThenBy
  ...
  QueryBuilder<Subscription, Subscription, QAfterSortBy> thenByNextReminder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'nextReminder', Sort.asc);
    });
  }
  ...
  QueryBuilder<Subscription, Subscription, QAfterSortBy>
      thenByNextReminderDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'nextReminder', Sort.desc);
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterSortBy> thenByPlanType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'planType', Sort.asc);
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterSortBy> thenByPlanTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'planType', Sort.desc);
    });
  }
...
extension SubscriptionQueryWhereDistinct
  ...
  QueryBuilder<Subscription, Subscription, QDistinct>
      distinctByIntervalInDays() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'intervalInDays');
    });
  }
  ...
  QueryBuilder<Subscription, Subscription, QDistinct> distinctByNextReminder() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'nextReminder');
    });
  }

  QueryBuilder<Subscription, Subscription, QDistinct> distinctByPlanType(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension SubscriptionQueryProperty
  ...
  QueryBuilder<Subscription, int, QQueryOperations> intervalInDaysProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'intervalInDays');
    });
  }
  ...
  QueryBuilder<Subscription, DateTime?, QQueryOperations>
      nextReminderProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'nextReminder');
    });
  }

  QueryBuilder<Subscription, String, QQueryOperations> planTypeProperty() {
    return QueryBuilder.apply(this, (query) {
